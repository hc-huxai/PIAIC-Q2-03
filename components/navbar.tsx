...
const Navbar = () => {
  return (
    <header className="w-full h-14 border-b border-b-gray-300 p-6 flex items-center justify-between gap-4 fixed top-0">
      {/* Logo */}
      <div className="flex items-center gap-x-2 cursor-pointer opacity-100 hover:opacity-75 transition-opacity">
      ...
      <div className="ml-0 mr-auto flex items-center gap-x-2 bg-gray-100 py-2 px-4 rounded-3xl">
        <input type="text" className="focus:outline-none peer bg-gray-100 text-sm" placeholder="Search" />
        <Search strokeWidth={1.3} size={20} className="stroke-gray-700 peer-focus:stroke-black transition-all cursor-pointer hover:stroke-black" />{" "}
      </div>
